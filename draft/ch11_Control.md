...
운전 강사와 초보 운전자 비유가 딱 들어맞는 장입니다. 강사가 *"다음 교차로에서 우회전해서 200m 직진하세요"* 라고 하면, 초보는 *"핸들을 정확히 몇 도 돌려야 하지? 지금 속도 줄이나? 몇 미터 앞에서 브레이크를 밟지?"* 를 별도로 계산합니다. 강사의 말은 **Planning**, 초보가 몸으로 실행하는 건 **Control**. 둘 다 "차가 어떻게 움직일지" 를 다루지만 **추상 수준과 시간 축** 이 다릅니다. 강사는 몇 분 뒤의 지도를 말하고, 초보의 손발은 지금 이 순간의 각도를 다루죠. 이 차이를 분명히 해두는 것으로 11장을 열겠습니다.
