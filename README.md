...
```
physical-ai-book/
├── draft/            # 본문 원고(서문·목차·30장·부록 4개)
├── ebook/
│   ├── 전체원고_v1.2.md          # 한 파일로 묶인 최종 원고
│   ├── cover/                   # 표지 SVG 3안(A/B/C)
│   ├── 책소개_상세.md
│   ├── 메타데이터.md
│   ├── 가격전략.md
│   ├── 표지_컨셉.md
...
책 출간 이후 각 장별 실습 노트북(`ch04_isp/`, `ch05_hydra/`, `ch06_occ/` ...) 과 Docker 환경이 순차적으로 추가될 예정입니다.
